            ...
            <form action="<?php echo base_url('Procedures/completeapp');?>" method="POST" id="complete_app">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-end">
                                <a id="resched_btn" title="Reschedule Appointment" href="#!" class="btn btn-sm btn-danger"><i class="fa-solid fa-clipboard-list"></i></a>
                                <a id="cancel_btn" title="Cancel Appointment" href="#!" class="btn btn-sm btn-danger"><i class="fa-solid fa-ban"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="row mt-3">
                    <div class="offset-lg-2 col-lg-4 pb-10 pt-10">
                        <div class="form-group text-center"> 
                            <a id="create_treatmentplan" href="#!" class="btn btn-sm btn-info"><i class="fa-solid fa-rectangle-list"></i> Create/View Treatment Plan</a>
                        </div>
                    </div>
                    <div class="col-lg-4 pb-10 pt-10">
                        <div class="form-group text-center">
                            <a id="periodontal_chart" href="#!" class="btn btn-sm btn-info"><i class="fa-solid fa-tooth"></i> Create/View Periodontal Chart</a>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="resched_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="submit_resched" action="#!" method="POST">
                <div class="modal-header" style="background-color:white;">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="new_date" class="fw-bold">New Date:</label>
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="resched_reason" class="fw-bold">Reason:</label>
                                <input type="text" class="form-control" id="resched_reason" name="resched_reason">
                            </div>
                        </div>    
                    </div>                    
                    <div class="row mt-5">
...
<div class="modal fade" id="cancel_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="submit_cancel" action="#!" method="POST">
                <div class="modal-header" style="background-color:white;">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="cancel_reason" class="fw-bold">Reason:</label>
