...
<?= $this->include('scripts/BranchList_script')  ?>
                            ...
                            <div class="card-body d-flex justify-content-between flex-column">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="text-end">
                                            <button data-bs-toggle="modal" data-bs-target="#add_branch_modal" type="button" class="btn-shadow btn btn-primary">
                                ...
                                <div class="d-flex flex-column">
                                    <!--begin::Number-->
                                    <span class="text-center fw-bold fs-2x text-gray-800 lh-1 ls-n2 mb-3">Branch List</span>
                                    <hr>
                                    <!--center::Number-->
                                </div> 
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group table-responsive">
                                            <table id="branch_tbl" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        <th class="fw-bold text-center">Branch Code</th>
                                                        <th class="fw-bold text-center">Branch Description</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="fw-bold" for="Branch_Desc">Branch Description:</label>
                                <input type="text" class="form-control" name="Branch_Desc" id="Branch_Desc">
                            </div>
                        </div>
                    </div> 
                </div>
                <div class="modal-footer">
                    ...
                    <button id="submit_branch" type="submit" class="btn btn-sm btn-success">Save changes</button>
                </div>
            </div>
        </div>
    </div>
