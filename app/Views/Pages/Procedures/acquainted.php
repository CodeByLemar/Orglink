...
<?= $this->include('scripts/Acquainted')  ?>
                                ...
                                <div class="card-body d-flex justify-content-between flex-column">
                                    ...
                                    <div class="row">
                                        <div class="d-flex flex-column mt-4 col-lg-6">
                                            ...
                                            <ul id="results" class="mt-5 results-list"></ul>
                                    ...
                                    <div class="row">
                                        <div class="d-flex flex-column mt-4 col-lg-4">
                                            <label class="fw-semibold text-gray-800 lh-1 ls-n2 mb-2" for="Discount">Discount</label>
                                        ...
                                        <div class="discount_ref_div">
                                            <div class="d-flex flex-column mt-4 col-lg-4">
                                                <label class="fw-semibold text-gray-800 lh-1 ls-n2 mb-2" for="disc_ref_no">Ref ID No.</label>
                                                <input type="text" name="disc_ref_no" id="disc_ref_no" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-lg-100 shadow-lg">
                                ...
                                <div class="card-body d-flex justify-content-between flex-column">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-flex flex-column mt-4 col-lg-2">
                                            <label class="form-check-label fw-semibold text-gray-800 lh-1 ls-n2" for="Q2_Yes">
                                            <input class="form-check-input" type="radio" name="Q2" id="Q2_Yes" value="1"> <span class="ms-2">Yes</span> </label>
                                        </div>
                                        <div class="d-flex flex-column mt-4 col-lg-2">
                                            <label class="form-check-label fw-semibold text-gray-800 lh-1 ls-n2" for="Q2_No">
                                            <input class="form-check-input" type="radio" name="Q2" id="Q2_No" value="0"> <span class="ms-2">No</span> </label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="d-flex flex-column mt-4 col-lg-8">
                                        ...
                                        <div class="d-flex flex-column mt-4 col-lg-2">
                                            <label class="form-check-label fw-semibold text-gray-800 lh-1 ls-n2" for="Q3_Yes">
                                            <input class="form-check-input" type="radio" name="Q3" id="Q3_Yes" value="1"> <span class="ms-2">Yes</span> </label>
                                        </div>
                                        <div class="d-flex flex-column mt-4 col-lg-2">
                                            <label class="form-check-label fw-semibold text-gray-800 lh-1 ls-n2" for="Q3_No">
                                            <input class="form-check-input" type="radio" name="Q3" id="Q3_No" value="0"> <span class="ms-2">No</span> </label>
                                        </div>  
                                    </div>
                                    <div class="row">
                                        <div class="d-flex flex-column mt-4 col-lg-8">
                                        ...
                                        <div class="d-flex flex-column mt-4 col-lg-2">
                                            <label class="form-check-label fw-semibold text-gray-800 lh-1 ls-n2" for="Q4_Yes">
                                            <input class="form-check-input" type="radio" name="Q4" id="Q4_Yes" value="1"> <span class="ms-2">Yes</span> </label>
                                        </div>
                                        <div class="d-flex flex-column mt-4 col-lg-2">
                                            <label class="form-check-label fw-semibold text-gray-800 lh-1 ls-n2" for="Q4_No">
                                            <input class="form-check-input" type="radio" name="Q4" id="Q4_No" value="0"> <span class="ms-2">No</span> </label>
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="d-flex flex-column mt-4 col-lg-8">
                                        ...
                                        <div class="d-flex flex-column mt-4 col-lg-2">
                                            <label class="form-check-label fw-semibold text-gray-800 lh-1 ls-n2" for="Q5_Yes">
                                            <input class="form-check-input" type="radio" name="Q5" id="Q5_Yes" value="1"> <span class="ms-2">Yes</span> </label>
                                        </div>
                                        <div class="d-flex flex-column mt-4 col-lg-2">
                                            <label class="form-check-label fw-semibold text-gray-800 lh-1 ls-n2" for="Q5_No">
                                            <input class="form-check-input" type="radio" name="Q5" id="Q5_No" value="0"> <span class="ms-2">No</span> </label>
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="d-flex flex-column mt-4 col-lg-8">
